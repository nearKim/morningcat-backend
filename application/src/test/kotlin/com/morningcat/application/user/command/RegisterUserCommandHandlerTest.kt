...
class RegisterUserCommandHandlerTest :
    StringSpec({
        ...
        "RegisterUserCommandHandler should save both User and Subscription when registering a new user" {
            ...
            val mockSubscriptionRepository =
        ...
        "RegisterUserCommandHandler should return error when user with email already exists" {
            ...
            val mockUserRepository =
                object : UserRepository {
                    ...
                    override suspend fun save(user: User): Unit = throw AssertionError("Should not save when user already exists")
                }
            ...
            val mockSubscriptionRepository =
                object : SubscriptionRepository {
                    ...
                    override suspend fun save(subscription: Subscription): Unit =
